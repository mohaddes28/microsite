                            ...
                            <div class="col-9 p-0">
                                <div class="tab-content p-3 card" >
                                    <div class="tab-pane fade show active">
                                        <form action="{{ route('admin.page.home.section.update', 'about-section') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('put')
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mb-2">
                                                    ...
                                                    <input type="file" name="image" value="{{ $section->image ?? '' }}" id="image"
