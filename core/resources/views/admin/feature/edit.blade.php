    ...
    <div class="container-fluid px-4">
        ...
        <div class="card">
            <div class="card-header">
                <span class="card-subtitle">Edit Feature</span>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        ...
                        <form action="{{ route('admin.feature.update', $feature->id) }}" enctype="multipart/form-data" method="POST">
                            @method('put')
                            @csrf
                            <div class="row">
                                <div class="col-md-12 mt-2">
                                    <label for="name">Name <span class="text-danger">*</span></label>
                                    <input type="text" name="name" value="{{ $feature->name }}" id="name"
