        ...
        <div class="container lg:mt-10 mt-10">
            <div class="md:flex">
                <div class="lg:w-3/4 md:w-2/3 md:px-3 mt-[30px] md:mt-0">
                    ...
                    <h3 class="mb-1 mt-10 md:text-2xl text-2xl md:leading-normal leading-normal font-semibold">Most popular hashtags on Instagram <button style="font-size: 14px;border: solid 1px blue;background: #6464fb;color:#fff;padding: 0px 6px;border-radius: 4px;margin-top: 10px;float: right;" type="button" onclick="copySection(this, 'popular-hashtag')"><i class="uil uil-file-copy-alt"></i> Copy</button></h3>
                    <div id="popular-hashtag" style="display: none;">
                        <?php $count = 0; ?>
                        @foreach($hashtag->instagram_hashtags as $ins)
                    ...
                    <div class="rounded-md shadow dark:shadow-gray-800">
                        <table class="w-full text-left text-slate-500 dark:text-slate-400">
                            ...
                            <?php $count = 0; ?>
                            @foreach($hashtag->instagram_hashtags as $ii => $ins_hashtag)
                                <?php if($count == 30) break; ?>
                                <tr class="bg-white dark:bg-slate-900 text-center">
                                    <td>{{ $ii+1 }}</td>
                                    <td class="text-left">{{ $ins_hashtag->hashtag }}</td>
                                    <td>{{ $ins_hashtag->relevance }}</td>
                                    <td>{{ !empty($ins_hashtag->total_posts) ? \App\Helpers\NumberToWord::convertBigWord($ins_hashtag->total_posts) : '' }}</td>
                                    <td>{{ !empty($ins_hashtag->posts_per_hour) ? \App\Helpers\NumberToWord::convertBigWord($ins_hashtag->posts_per_hour) : '' }}</td>
                                    <td>{{ !empty($ins_hashtag->average_likes) ? \App\Helpers\NumberToWord::convertBigWord($ins_hashtag->average_likes) : '' }}</td>
                                    <td>{{ !empty($ins_hashtag->lowest_likes) ? \App\Helpers\NumberToWord::convertBigWord($ins_hashtag->lowest_likes) : '' }}</td>
                                    <td>{{ !empty($ins_hashtag->average_comments_top_posts) ? \App\Helpers\NumberToWord::convertBigWord($ins_hashtag->average_comments_top_posts) : '' }}</td>
                                </tr>
                                <?php $count++; ?>
                            @endforeach
                            </tbody>
                    ...
                    <h3 class="mb-1 mt-10 md:text-2xl text-2xl md:leading-normal leading-normal font-semibold">Related Hashtags <button style="font-size: 14px;border: solid 1px blue;background: #6464fb;color:#fff;padding: 0px 6px;border-radius: 4px;margin-top: 10px;float: right;" type="button" onclick="copySection(this, 'related-hashtag')"><i class="uil uil-file-copy-alt"></i> Copy</button></h3>
                    ...
                    <h3 class="mb-1 mt-10 md:text-2xl text-2xl md:leading-normal leading-normal font-semibold">Popular hashtags <button style="font-size: 14px;border: solid 1px blue;background: #6464fb;color:#fff;padding: 0px 6px;border-radius: 4px;margin-top: 10px;float: right;" type="button" onclick="copySection(this, 'pop-hashtag')"><i class="uil uil-file-copy-alt"></i> Copy</button></h3>
                    <div class="rounded-md shadow dark:shadow-gray-800">
